...
from fi import sw_fi

from transformers.save_output import Save_Output

from parsers.ucXception_SW_parser import *
...
class SW_Faults_Example(Base_Campaign):
    ...
    source_path = "./test/nthprime.c"  # Path of the source file that will be used for SW FI
    #source_path = "/root/test/nthprime.c"  # Path of the source file that will be used for SW FI

    app_path = "./test/nthprime"
    ...
    fi = (sw_fi, "localhost", "/home/frederico/Dropbox/demo_sw/Injetor.jar")
    #fi = (sw_fi, target, "/root/test/Injetor.jar")
    ...
    parsers = (
        ...
        (App_Output_Md5, (Eval_It("[self.app_output, 7, '16d6dcd505aa4585d1a8f619dd3dddb9']"),)),
        (ucXception_SW_Parser, (Eval_It("[self.patch_files, self.patch_file]"),)),
    )
