...
int recurse(int pos, int max, int width)
{
	...
	//  /  /  |
	// |  /  /  
	if (((bufferPos == '/') && (bufferPosWidth == '|')) ||
	   ((bufferPos == '/') && (bufferPosWidth == '/')) ||
	   ((bufferPos == '|') && (bufferPosWidth == '/'))) {
	...
	if (((bufferPos == '|') && (bufferPosWidth1== '|')) ||
	   ((bufferPos == '\\') && (bufferPosWidth1 == '/')) ||
	   ((bufferPos == '/') && (bufferPosWidth1 == '\\'))) {
	...
	if (((bufferPos == '\\') && (bufferPosWidth2 == '|')) ||
	   ((bufferPos == '\\') && (bufferPosWidth2 == '\\')) ||
	   ((bufferPos == '|') && (bufferPosWidth2 == '\\'))) {
