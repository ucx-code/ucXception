...
struct _slot { unsigned int begin; unsigned int end; };
...
int main()
{
     ...
     //posix_fadvise(0, 0, statbuf.st_size, POSIX_FADV_NOREUSE);
     ...
     /* Ordena do que come̤a mais cedo para o que come̤a mais tarde */    
