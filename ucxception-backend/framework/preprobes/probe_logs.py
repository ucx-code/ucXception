from framework.preprobes.base_probe import Base_Probe
...
class Probe_Logs(Base_Probe):
    ...
    known_logs = {
        ...
        "openstack": ("/var/log/apache2", "/var/log/cinder", "/var/log/glance", "/var/log/keystone", "/var/log/mysql", "/var/log/neutron", "/var/log/nova",),
    }
