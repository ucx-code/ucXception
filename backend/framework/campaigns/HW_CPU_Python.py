...
class HW_CPU_Python(Base_Campaign):
    """ AI4EU conf
    """
    ...
    def __init__(self, input):
        ...
        """
        super(HW_CPU_Python, self).__init__(input)

    def run(self, run_id):
        super(HW_CPU_Python, self).run(run_id)
    ...
    def launch(self):
        self._start_clock()
        self.p = utils.run_anywhere(self.target, "python3", self.app_path + " " + self.app_input, True, True, True)
