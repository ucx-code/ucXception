...
from framework.parsers.app_openstack_parser import App_Openstack_Parser
...
class FailureCampaign(Base_Campaign):
    ...
    fi = (hw_fi, ssh("192.168.2.22", "root"), "/fi-tools/failure/simple_crash")
    ...
    parsers = (
        ...
        (App_Openstack_Parser, ("[self.app_output,]",)),
    )
    ...
    def __init__(self, input):
        ...
        """
        super(FailureCampaign, self).__init__(input)

    def run(self, run_id):
        super(FailureCampaign, self).run(run_id)
