...
{
    int det = (pontos[p1][0] * pontos[p2][1] + pontos[p2][0] * pontos[p3][1] + pontos[p3][0] * pontos[p1][1]) - (pontos[p1][1] * pontos[p2][0] + pontos[p2][1] * pontos[p3][0] + pontos[p3][1] * pontos[p1][0]);
    return det;
}
